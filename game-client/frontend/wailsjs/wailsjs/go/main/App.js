...
export function GetClientIdentityJSON() {
  return window['go']['main']['App']['GetClientIdentityJSON']();
}
...
export function LoadManagerClientsJSON() {
  return window['go']['main']['App']['LoadManagerClientsJSON']();
}
